        ...
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-label">
                <h3 class="kt-portlet__head-title">
                    <i class="fa fa-edit"></i> {{ $edit ? 'Edit '. $object->name : 'Add new Client' }}
                </h3>
            </div>
        </div>
        <div class="kt-portlet__body">
            ...
            <div class="kt-section">
                <div class="kt-section__content">
                    <form action="{{ ! $edit ? route('admin:clients.store'): route('admin:clients.update' , $object->id) }}" method="POST">
                        @csrf
                        @if ( $edit )
                            @method('PUT')
                        @endif
...
@section('actionButton')
    <div class="kt-subheader__toolbar">
        <div class="btn-group">
            <a href="{{route("admin:clients.index")}}" class="btn btn-brand btn-bold">
...
@section('subheader')
    ...
    <a href="{{ route('admin:clients.index') }}" class="kt-subheader__breadcrumbs-link">
        Clients
    </a>
@endsection
